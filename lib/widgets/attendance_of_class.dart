...
//function provides list of all registered students in the class
  List<Student> allRegStuds(
      List<Student> source, SubjectClass currentClassSub, AllStudents prov) {
    final regStudIds = prov.getRegStudsID(currentClassSub.subjectName);
    return source.where((i) => regStudIds.contains(i.getId)).toList();
  }
